"""
Django settings for Itqan project.
...
SECRET_KEY = 'django-insecure-o=)d+v1-d4!c50)ah*c6zw!8hkelxq33*gizc6oz!vn(+(0d$p'
...
WSGI_APPLICATION = 'Itqan.wsgi.application'
